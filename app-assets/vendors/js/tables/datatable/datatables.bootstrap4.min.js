...
!b(a.currentTarget).hasClass("disabled")&&o.page()!=a.data.action&&o.page(a.data.action).draw("page")};l=0;for(h=f.length;l<h;l++)if(c=f[l],b.isArray(c))q(d,c);else{g=e="";switch(c){case "ellipsis":e="&#x2026;";g="disabled";break;case "Inizio":e=k.sFirst;g=c+(0<j?"":" disabled");break;case "Indietro":e=k.sPrevious;g=c+(0<j?"":" disabled");break;case "Avanti":e=k.sNext;g=c+(j<n-1?"":" disabled");break;case "Fine":e=k.sLast;g=c+(j<n-1?"":" disabled");break;default:e=c+1,g=j===c?"active":""}e&&(i=b("<li>",
