...
@section('content')
    <div class="card">
        ...
        <form class="form form-vertical" method="POST" action="{{ route('plans_handheld.update',$planHandheld->id)}}">
            @csrf
            {{ method_field('PATCH') }}
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8" id="wrap-note">
                            ...
                            <textarea name="note" value="{{$planHandheld->note}}" class="form-control input-sm" placeholder="Note"></textarea>
